...
do
	...
	echo "lynx -dump ftp://ladsftp.nascom.nasa.gov/allData/5/MYD03/$Year/$strDoY | cut -d/ -f4-9 >> 2011"
	lynx -dump ftp://ladsftp.nascom.nasa.gov/allData/5/MYD03/$Year/$strDoY | cut -d/ -f4-9 > tmp
