...
do
    ...
    echo $SRCDIR/Weigthed_f0.py $BRDF_NoSnow $BRDF_Snow $DATADIR/processing/$tile/f0
    $SRCDIR/Weigthed_f0.py $BRDF_NoSnow $BRDF_Snow $DATADIR/processing/$tile/f0 > $tile.$year$strDoY.log
