...
if len ( sys.argv ) == 7:
    ...
    joblib.dump(clf, 'MELODIES_DT_clf.pkl') 
...
# Most probable class
new_dataset = driver.Create( 'DT_LCC_subset.tif', 
                NIR.shape[2], NIR.shape[1], 1, gdal.GDT_Byte )
new_dataset.GetRasterBand(1).WriteArray(classification)
new_dataset = None

# Probability
new_dataset = driver.Create( 'DT_LCP_subset.tif', 
                NIR.shape[2], NIR.shape[1], classes.shape[0], gdal.GDT_Float32 )
